...
<main class="relative min-h-screen w-full bg-[#0a0a0b] text-white flex flex-col items-center justify-center px-4 overflow-hidden font-sans">
    ...
    <div class="flex justify-between fixed top-0 left-0 w-full h-20 items-center px-4 py-2 md:px-8 md:py-4">
    ...
    <div class="relative z-10 w-full max-w-3xl mt-10 flex flex-col items-center text-center">
